...
import (
	...
	machinelearning_seldon_io_v1alpha2 "github.com/ppkube/res-types/pkg/apis/machinelearning.seldon.io/v1alpha2"
	versioned "github.com/ppkube/res-types/pkg/client/clientset/versioned"
	internalinterfaces "github.com/ppkube/res-types/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha2 "github.com/ppkube/res-types/pkg/client/listers/machinelearning.seldon.io/v1alpha2"
...
type SeldonDeploymentInformer interface {
	...
	Lister() v1alpha2.SeldonDeploymentLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MachinelearningV1alpha2().SeldonDeployments(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MachinelearningV1alpha2().SeldonDeployments(namespace).Watch(options)
			},
		},
		&machinelearning_seldon_io_v1alpha2.SeldonDeployment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *seldonDeploymentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&machinelearning_seldon_io_v1alpha2.SeldonDeployment{}, f.defaultInformer)
}

func (f *seldonDeploymentInformer) Lister() v1alpha2.SeldonDeploymentLister {
	return v1alpha2.NewSeldonDeploymentLister(f.Informer().GetIndexer())
}
