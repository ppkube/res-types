...
import (
	v1 "github.com/ppkube/res-types/pkg/apis/machinelearning.seldon.io/v1"
	scheme "github.com/ppkube/res-types/pkg/client/clientset/versioned/scheme"
...
type SeldonDeploymentInterface interface {
	...
	Get(name string, options meta_v1.GetOptions) (*v1.SeldonDeployment, error)
	List(opts meta_v1.ListOptions) (*v1.SeldonDeploymentList, error)
...
func (c *seldonDeployments) Get(name string, options meta_v1.GetOptions) (result *v1.SeldonDeployment, err error) {
...
func (c *seldonDeployments) List(opts meta_v1.ListOptions) (result *v1.SeldonDeploymentList, err error) {
...
func (c *seldonDeployments) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("seldondeployments").
...
func (c *seldonDeployments) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *seldonDeployments) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("seldondeployments").
